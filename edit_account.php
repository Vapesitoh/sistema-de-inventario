  ...
  if(isset($_POST['update'])){
    ...
    $result = $db->query($sql);
          if($result && $db->affected_rows() === 1){
            $session->msg('s',"Datos de la cuenta han sido actualizados ");
            redirect('edit_account.php', false);
          } else {
            $session->msg('d',' Lo siento los Datos de la cuenta no han podido ser actualizados!');
            redirect('edit_account.php', false);
          }
    } else {
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span>Cambiar foto de usuario</span>
          </div>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
                <img class="img-circle img-size-2" src="cargas/usuarios/<?php echo $user['image'];?>" alt="">
            </div>
            <div class="col-md-8">
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    ...
                    <button type="submit" name="update" class="btn btn-info">Actualizar datos</button>
            </div>
        </form>
      </div>
    </div>
